...
module.exports = (testEnvironment = 'jsdom') => ({
  ...defaults,
  testEnvironment,
  testPathIgnorePatterns: [...defaults.testPathIgnorePatterns, '/docusaurus/'],
  transform: {
    // Enable Babel so that `jest.mock` and friends are automatically hoisted,
    // even if we don't use Babel for the source code
