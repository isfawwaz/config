...
module.exports = {
  rules: {
    ...
    'capitalized-comments': [
      ...
      {
        ignorePattern: [
          // Ignore comments that have possible code samples as the first word
          // (camelCase, some-prop, fn(), etc.)
          '[a-z0-9]+[A-Z_\\-.()\'"`]',
    ...
    // Disallow using Object.assign with an object literal as the first argument
    // and prefer the use of object spread instead
    // comment: can't use this rule as it errors in <= ES2017; instead,
    // we are enabling it in `es2018`
